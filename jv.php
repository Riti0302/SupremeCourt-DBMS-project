...
<body>
    ...
    <div class="row">
        <div class="card col-sm-6">
            ...
            <div class="card-body ">
                ...
                <li class="list-group-item list-group-item-action text-center ">
                    ...
                    <li class="list-group-item text-center ">
                        <a href="jv.php" class="card-body-text" style="color:red;"><strong>●Judgements &amp; Verdicts</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content" style="margin-top: 50px; margin-left: 200px;">
            ...
            <hr>
                <form action="jvcase.php" method="POST" style="margin-bottom: 10px">
                    <input id="search" size="40" type="text" name="case" placeholder="Search by Case No." >
                </form>
                <form action="jvdiary.php" method="POST" style="margin-bottom: 10px">
                  <input id="search" size="30" type="text" name="diary" placeholder="Search by Diary No.">
                </form>
                <form action="jvdate.php" method="POST" style="margin-bottom: 10px">
