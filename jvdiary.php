    ...
    <div class="row">
        ...
        <table >
            ...
            <?php
                ...
                $sql = "SELECT triggerjudgement.*,judgement.jd,judgement.description FROM triggerjudgement INNER JOIN judgement ON triggerjudgement.cno = judgement.caseno WHERE diaryno='$code'";
