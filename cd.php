        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" style="padding: 0px; margin-top: 12px; margin-left: 5px;" aria-current="page" href="./Home.html"><i class="fas fa-home">Home</i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="anc.html">Notification & Circular</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Daily Order</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content" style="margin-top: 50px; margin-left: 200px;">
            ...
            <table>
                ...
                $sql = "SELECT cno,diaryno,ctype,cyear,pname,rname,radvocates,padvocates,judges,nh,jd,description FROM cs WHERE cyear='$code'";
