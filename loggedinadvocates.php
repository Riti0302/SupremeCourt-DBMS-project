...
<head>
    ...
    <title>Advocate|Supreme Court Of India</title>
</head>
    ...
    <div class="row">
            ...
            <div class="card-body ">
                ...
                <li class="list-group-item list-group-item-action text-center ">
                    ...
                    <li class="list-group-item text-center ">
                        <a href="./loggedinadvocates.php" style="color:red;" class="card-body-text "><strong>●Advocates</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content" style="margin-top: 50px; margin-left: 200px;">
            <div class="centerbar">
                    ...
                    <form action="advo_insert.php" method="POST" onsubmit="return executeOnSubmit();">
                        Name:
                        <br>
                        <input type="text" name="a_name" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                        Code:
                        <br>
                        <input type="text" name="a_code" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                        Mobile No.:
                        <br>
                        <input type="text" name="m_no" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                        Email-ID:
                        <br>
                        <input type="text" name="email" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                        Address:
                        <br>
                        <input type="text" name="address" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                        Charge Per Appearence:
                        <br>
                        <input type="text" name="charge" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                        Acheivments:
                        <br>
                        <input type="text" name="acheivments" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr><td> " . $row["name"]."</td><td>".$row["code"]."</td><td>".$row["mobile_no"]."</td><td>".$row["email_id"]."</td><td>".$row["address"]."</td><td>".$row["charge"]."</td><td>".$row["acheivments"]."</td><td>"." <button onclick=\"location.href='advocateDetailsDelete.php?id=".$row['code']."'\" style='color:white; background-color:red; border-radius: 4px;'>Delete</button></td>"."</td></tr>";
                            }
                        } else {
                            echo "0 results";
                        }
