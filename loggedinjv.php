        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="loggedinjv.php" tabindex="-1" aria-disabled="true">Daily Order</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        <div class="card col-sm-6">
            ...
            <div class="card-body ">
                <div class="list-group ">
                    ...
                    <li class="list-group-item text-center ">
                        <a href="./loggedinjv.php" class="card-body-text" style="color:red;"><strong>●Judgements &amp; Verdicts</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content" style="margin-top: 50px; margin-left: 200px;">
            <div class="centerbar">
                    ...
                    <form action="jv_insert.php" method="POST">
                        Case No.:
                        <br>
                        <input type="text" name="j_case" required style="width: 100%; border-radius: 4px;">
                        <br>
                        Judgement or Order Date:
                        <br>
                        <input type="text" placeholder="YYYY-MM-DD" name="j_date" required style="width: 100%; border-radius: 4px;">
                        <br>
                        Description:
                        <br>
                        <input type="text" name="description" required style="width: 100%; border-radius: 4px;">
                        <br>
