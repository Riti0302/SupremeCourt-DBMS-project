...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="do.php" tabindex="-1" aria-disabled="true">Daily Order</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content" style="margin-top: 50px; margin-left: 200px;">
            <h2>Daily Orders</h2>
            <hr>
                <form action="dodate.php" method="POST" style="margin-bottom: 10px">
                  <input id="search" type="text" style="border-radius: 4px;" size="30" name="date" placeholder="Search by Date (YYYY-MM-DD)">
                </form>
            <table>
                <tr>
                    <th>Case No.</th>
