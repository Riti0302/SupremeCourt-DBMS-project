...
<head>
    ...
    <title>Judge|Supreme Court Of India</title>
</head>
...
<body>
    ...
    <div class="row">
            ...
            <div class="card-body ">
                <div class="list-group ">
                    <li class="list-group-item list-group-item-action text-center ">
                        <a href="./judge.php" class="card-body-text" style="color:red;"><strong>●Judges</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
                        <a href="./advocates.php" class="card-body-text"><strong>●Advocates</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content ">
            <h1 class="cheif_justice_heading">Chief Justice of India</h1>
            <hr>
            <img class="chief_justice_img" src="./img/cheif_Justice_N.V._Ramana.jpg" alt="chief justice of india">
            <div class="chief_justice_abt">
                <h1 class="chief_justice_name"><strong>Hon'ble Mr. N.V. Ramana</strong></h1>
                <br>
                <h2 class="chief_justice_position"> The Chief Justice Of India</h2>
                <br>
                <h4 class="chief_justice_age">DoB : 27-08-1957</h4>
                <br>
                <h4 class="chief_justice_terms">Term of Office: (DoA) 17-02-2014 to (DoR) 26-08-2022</h4>
                <br>
                <h4 class="chief_justice_appointment">Appointed as The Chief Justice of India on 24-04-2021</h4>
            </div>
            <br>
            <table >
                <tr>
