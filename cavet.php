...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="./Home.html"><i class="fas fa-home">Home</i></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        <div class="card col-sm-6">
            ...
            <div class="card-body ">
                <div class="list-group ">
                    ...
                    <li class="list-group-item text-center ">
                        <a href="cavet.php" class="card-body-text " style="color:red;"><strong>●Caveat</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
        ...
        <div class="container col-sm offset-sm body-content">
            <h1 class="noticencircular-heading">
                Caveats
            </h1>
            <hr>
            <table >
            ...
            <div class="row ">
                ...
                <div class="col-6 col-sm-7 offset-sm-1 1align-self-center ">
                    ...
                    <address class="address ">
                        ...
                        <i class="fas fa-envelope fa-lg ">:<a href="mailto:scbaec@gmail.com ">scbaec@gmail.com</a></i>
                    </address>
                </div>
            </div>
