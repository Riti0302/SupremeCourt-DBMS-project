    ...
    <div class="row">
        <div class="card col-sm-6">
            ...
            <div class="card-body ">
                ...
                <li class="list-group-item list-group-item-action text-center ">
                    ...
                    <li class="list-group-item text-center ">
                        <a href="./loggedincs.php" style="color:red;" class="card-body-text "><strong>●Case Status</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content" style="margin-top: 50px; margin-left: 200px;">
            <div class="centerbar">
                    ...
                    <form action="casestatus_insert.php" method="POST" onsubmit="return executeOnSubmit();">
                        Case No.:
                        <br>
                        ...
                        Next Hearing:
                        <br>
                        <input type="text" name="nh" placeholder="YYYY-MM-DD" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                        Description:
                        <br>
                        <input type="text" name="description" required style="width: 100%; height: 5vh; border-radius: 4px;">
                        <br>
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                               // echo "<tr><td> " . $row["cno"]."</td><td>".$row["diaryno"]."</td><td>".$row["ctype"]."</td><td>".$row["cyear"]."</td><td>".$row["pname"]."</td><td>".$row["rname"]."</td><td>".$row["radvocates"]."</td><td>".$row["padvocates"]."</td><td>".$row["judges"]."</td><td>".$row["nh"]."</td><td>".$row["description"]."</td><td>"." <button style='color:white; background-color:red; border-radius: 4px; onclick=\"location.href='caseDetailsDelete.php?id=".$row['cno']."'\">Delete</button></td>"."</td></tr>";
                               echo "<tr><td> " . $row["cno"]."</td><td>".$row["diaryno"]."</td><td>".$row["ctype"]."</td><td>".$row["cyear"]."</td><td>".$row["pname"]."</td><td>".$row["rname"]."</td><td>".$row["radvocates"]."</td><td>".$row["padvocates"]."</td><td>".$row["judges"]."</td><td>".$row["nh"]."</td><td>".$row["description"]."</td><td>"." <button onclick=\"location.href='caseDetailsDelete.php?id=".$row['cno']."'\" style='color:white; background-color:red; border-radius: 4px;'>Delete</button></td>"."</td></tr>";
                             }
                        } else {
                            echo "0 results";
                        }
