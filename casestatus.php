    ...
    <div class="row">
        <div class="card col-sm-6">
            ...
            <div class="card-body ">
                ...
                <li class="list-group-item list-group-item-action text-center ">
                    ...
                    <li class="list-group-item text-center ">
                        <a href="casestatus.php" class="card-body-text" style="color:red;"><strong>●Case Status</strong></a>
                    </li>
                    <li class="list-group-item text-center ">
        ...
        <div class="container col-sm-6 offset-sm-3 body-content" style="margin-top: 50px; margin-left: 200px;">
            ...
            <form action="cno.php" method="POST">
              <input id="search"  size=40; type="text" name="cn" placeholder="Search by Case No." >
            </form>
             <form action="diaryno.php" method="POST" style="margin-top: 5px;">
              <input id="search" size=30; type="text" name="dn" placeholder="Search by Diary No.">
            </form>
            <form action="cd.php" method="POST" style="margin-top: 5px;">
              <input id="search" type="text" name="cd" placeholder="Search by Case Date" style="margin-bottom:10px;">
            </form>
            <table>
                <tr>
                    <th>Case No.</th>
